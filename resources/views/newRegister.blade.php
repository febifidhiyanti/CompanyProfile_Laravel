		...
		<div class="wrapper-page">
			<div class=" card-box">
				<div class="panel-heading">
					<h3 class="text-center">Daftar ke <strong class="text-custom"> Zunder </strong> </h3>
				</div>
				...
				<div class="panel-body">
					<form class="form-horizontal m-t-20" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group ">
							<div class="col-xs-12">
                                <input id="alamat" placeholder="Alamat" type="text" class="form-control @error('alamat') is-invalid @enderror" name="alamat" value="{{ old('alamat') }}" required autocomplete="alamat">
                        ...
                        <div class="form-group ">
							<div class="col-xs-12">
                                <input id="kota" placeholder="kota" type="text" class="form-control @error('kota') is-invalid @enderror" name="kota" value="{{ old('kota') }}" required autocomplete="kota">
                        ...
                        <div class="form-group ">
							<div class="col-xs-12">
                                <input id="jenis_kelamin" placeholder="Jenis Kelamin" type="text" class="form-control @error('jenis_kelamin') is-invalid @enderror" name="jenis_kelamin" value="{{ old('jenis_kelamin') }}" required autocomplete="jenis_kelamin">
